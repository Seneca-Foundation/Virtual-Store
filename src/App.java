...
public class App 
{
    public static void main(String[] args) throws Exception 
    {
        ...
        */
        ...
        allItems.add(new Computer("HP Envy", 1000.99 , "silver", "Window", "11th Generation Intel", "2019", 2.71, 2));
        ...
        allItems.add(new Book("Things Fall Apart", 14.00, "Chinua Achebe", "hardcover","depicts pre-colonial life in Nigeria", 1.36,24));
