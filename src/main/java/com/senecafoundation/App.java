...
public class App 
{
    public static void main( String[] args )
    {
        ...
        allItems.add(new Computer("Surface Book 3",1599.99,"black", "Windows", "Touch screen ", "2020", 4.2)); 
        allItems.get(4).setKeywords(new ArrayList<String>() {{ add("black");add("Touch screen");add("Surface Book");}}); 
        allItems.add(new Computer("Surface Pro 7",700.00,"red", "Windows", "laptop and tablet in one","2021",1.74)); 
        allItems.get(5).setKeywords(new ArrayList<String>() {{ add("red");add("tablet");add("Surface Pro");}}); 
     
        //basketball game tickets
        allItems.add(new Basketball("Brooklyn Nets vs Denver Nuggets",100,50, 24,"empty","October 11",0.2));
        allItems.get(6).setKeywords(new ArrayList<String>() {{ add("Denver Nuggets");add("Brooklyn");add("Nets");add("Denver");add("Brooklyn Nets");}}); 
        allItems.add(new Basketball("Chicago Bulls vs Phoenix Suns", 250.00,109, 30, "section is selling out fast","July 30", 0.2));
        ...
        allItems.add(new Basketball("Denver Nuggets vs Utah Jazz", 139,194, 49,"empty", "April 6", 0.2));
        allItems.get(8).setKeywords(new ArrayList<String>() {{ add("Denver Nuggets");add("Utah");add("Utah Jazz");add("cheapest");add("$139");}}); 
        allItems.add(new Basketball("Indiana Pacers vs Milwaukee Bucks", 194, 103, 53,"empty", "June 3", 0.2));
        allItems.get(9).setKeywords(new ArrayList<String>() {{ add("Indiana Pacer");add("Milwaukee Bucks");add("Bucks");add("Pacers");add("$194");}}); 
        allItems.add(new Basketball("LA Lakers vs Boston Celtics", 250.00,48, 15, "empty","September 24",0.2));
        allItems.get(10).setKeywords(new ArrayList<String>() {{ add("Laker");add("Boston");add("Celtics");add("great seats");add("$250");}}); 
        allItems.add(new Basketball("New York Knicks vs Philadelphia 76ers", 183,140, 49, "empty", "July 3",0.2)); 
        ...
        allItems.add(new Basketball("Oklahoma City Thunder vs LA Clippers", 192, 102, 43,"empty","January 3", 0.2));
        ...
        allItems.add(new Basketball("Phoenix Suns vs Bucks", 150, 80, 20, "empty","August 2", 0.2));
        allItems.get(13).setKeywords(new ArrayList<String>() {{ add("Phoenix Suns");add("Phoenix");add("Bucks");add("$150");}}); 
        allItems.add(new Basketball("San Antonio Spurs vs Memphis Grizzles",195, 34, 193,"empty", "January 5",0.2)); 
        ...
        //books
        allItems.add(new Book("Giovanni's Room", 30.00, "James Baldwin","paperback", "young, engaged man has an affair with a bartender", 0.51)); 
        allItems.get(15).setKeywords(new ArrayList<String>() {{ add("Giovanni");add("room");add("James Baldwin");add("$30");}});
        allItems.add(new Book("Hunger Games", 15.00, "Suzanne Collins", "hardcover", "24 teens fight each other until one is left standing", 0.7)); 
        allItems.get(16).setKeywords(new ArrayList<String>() {{ add("Hunger");add("games");add("Suzanne Collins");add("$15");}});
        allItems.add(new Book("Lord of the Flies", 11.30, "William Colding", "paperback","young boys are stranded on an island & chaos ensues", 0.3));
        ...
        allItems.add(new Book("The Book Thief", 11.99, "Markus Zusak", "paperback", "a girl steals books during WWII", 0.97)); 
        allItems.get(18).setKeywords(new ArrayList<String>() {{ add("Book Thief");add("book");add("Markus Zusak");add("$11.99");add("thief");}});
        allItems.add(new Book("The Color Purple", 12.99, "Alice Walker", "paperback","a black woman suffers abuse in the South", 0.55));
        allItems.get(19).setKeywords(new ArrayList<String>() {{ add("The Color Purple");add("color");add("Alice Walker");add("$12.99");add("purple");}});
        allItems.add(new Book("The Great Gatsby", 9.50, "F Scott Fitzgerald", "hardcover","a millionare is obsessed with reuniting with his former love", 0.34)); 
